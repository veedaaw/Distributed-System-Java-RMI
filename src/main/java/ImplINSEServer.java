...
public class ImplINSEServer extends UnicastRemoteObject implements InterfaceRMI {
    ...
    public ImplINSEServer() throws IOException {
        //super();
        ...
        logger = Logger.getLogger("INSE-Server");
    ...
    public String addUserToEnrolledUser(String name, String id) throws IOException {
        ...
        if (!getEnrolledUsers().containsKey(student.getID())) {
            result = "Student " + student.getID() + " added to INSE / Database!";
            System.out.println(result);
