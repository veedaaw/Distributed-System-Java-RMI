...
public class ImplCompServer extends UnicastRemoteObject implements InterfaceRMI

{
    ...
    public ImplCompServer() throws RemoteException
    {
        //super();
    ...
    public String addUserToEnrolledUser(String name, String id) throws IOException {
        ...
        {
            result = "Student " + student.getID() + " added to COMP/ Database!";
            System.out.println(result);
